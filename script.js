...
for (let i = 0; i < movieList.length; i++) {
  ...
  <h1> ${movieList[i]} </h1>
  `
  $("#display-area").append(movieList2)
}
...
let movieIronMan = {
    ...
    releaseDate: "Release Date: May 2, 2008",
    releasePosition: 1,
    description: "2008's Iron Man tells the story of Tony Stark, a billionaire industrialist and genius inventor who is kidnapped and forced to build a devastating weapon. Instead, using his intelligence and ingenuity, Tony builds a high-tech suit of armor and escapes captivity. When he uncovers a nefarious plot with global implications, he dons his powerful armor and vows to protect the world as Iron Man.",
    budget: "140,000,000",
    gross: "585,174,222",
    rottenTomatoes: "Rating on Rotten Tomatoes: 93%"
  }

  let movieIronManInfo  = `

  <img src= "${movieIronMan['moviePoster']}"}>
  <h1> ${movieIronMan['title']} </h1>
  <h2> ${movieIronMan['releaseDate']} </h2>
  <h2> ${movieIronMan['rottenTomatoes']} </h2>
  <p> ${movieIronMan['description']}</p>
  <h6> ${movieIronMan['budget']} </h6>
  <h6> ${movieIronMan['gross']} </h6>


`

$("#display-area").append(movieIronManInfo)
...
let newElement = `
<h1> ${me[‘name’]} </h1>
<p>I love ${me[‘favFood’]} Food in ${me[‘location’]}</p>
<img src=’${me[‘pic’]}’>
`
